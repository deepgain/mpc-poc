...
_SCALED_WEIGHTS_PATH = "../dataset/exercise_muscle_weights_scaled.csv"
...
def _load_exercise_data(yaml_path: str = "../dataset/exercise_muscle_order.yaml"):
...
df = _load_split("../dataset/training_data.csv")
...
with open(os.path.join(CHART_DIR, "README.md"), "w") as _f:
    ...
    _f.write(f"| Dataset | ../dataset/training_data.csv |\n")
